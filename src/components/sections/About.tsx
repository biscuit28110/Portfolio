      ...
      <div className="mx-auto max-w-6xl">
        <div className="grid items-center gap-12 lg:grid-cols-[1fr_340px] lg:gap-20">
          ...
          <div className="space-y-10">
            ...
            {/* Bio */}
            <motion.div {...fadeUp(0.1)} className="space-y-4 border-l-2 border-white/8 pl-5">
            ...
            {/* Stats */}
            <motion.div {...fadeUp(0.15)} className="flex flex-wrap items-start gap-8 border-y border-white/6 py-8 sm:gap-12">
          ...
          >
            <div className="relative">
              {/* Halo ambiant derrière la photo */}
              <div className="absolute -inset-4 rounded-3xl bg-cyan-500/10 blur-2xl" />

              {/* Carte photo */}
              <div className="relative overflow-hidden rounded-2xl border border-white/10 bg-white/[0.04] shadow-[0_24px_80px_rgba(0,0,0,0.4)]">
                ...
                {/* Badge disponible en overlay */}
                <div className="absolute bottom-4 left-4 right-4 flex items-center justify-between rounded-xl border border-white/10 bg-slate-950/70 px-4 py-3 backdrop-blur-md">
